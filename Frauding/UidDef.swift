...
class UidDef {
   ...
   static let hostname = "http://192.168.1.44:3000/"
   //static let hostname = "http://10.33.254.249:8000/"
...
extension UidDef {
    ...
    static func alertGoMapApp(viewController : UIViewController, coordonnees : CLLocationCoordinate2D?){
        ...
        let openMapAction = UIAlertAction(title: "Oui", style: .default) { (action) in
